        ...
        <div class="max-w-4xl mx-auto px-4 mt-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[2fr_1.2fr] gap-10 items-start">
               ...
               bg-gray-50 border-gray-300 text-gray-600">
                ...
                <div
                    class="hidden lg:block bg-gray-30 rounded-2xl p-6 border border-gray-200 shadow-lg sticky top-24 z-40">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            ...
                            <a wire:navigate
                                ...
                                target="_blank"
                                class="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition shadow-md">
